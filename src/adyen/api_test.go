...
import (
    ...
    "github.com/bos-hieu/adyen-go-api-library/v5/src/checkout"
    "github.com/bos-hieu/adyen-go-api-library/v5/src/common"
    "github.com/bos-hieu/adyen-go-api-library/v5/src/recurring"
...
func Test_api(t *testing.T) {
    t.Run("Create a new APIClient", func(t *testing.T) {
        ...
        assert.Equal(t, "https://checkout-test.adyen.com/checkout/v67", client.Checkout.BasePath())
